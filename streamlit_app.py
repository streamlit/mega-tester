...
st.markdown('st.markdown with <span style="background: red">HTML</span>', unsafe_allow_html=True)
...
st.caption('st.caption with <span style="background: red">HTML</span>', unsafe_allow_html=True)
